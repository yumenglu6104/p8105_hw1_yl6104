...
- `temp` (numeric): temperature in °F; min = 24.08, max = 57.92, mean = `r round(mean(early_january_weather$temp, na.rm = TRUE),2)` 
- `dewp` (numeric): dew point in °F; min = 8.96, max = 53.06, mean = 28.06  
- `humid` (numeric): relative humidity %; min = 32.86, max = 100, mean = 65.48
...
- `time_hour` (POSIXct): date and hour of the recording as a POSIXct date; range 2013-01-01 01:00:00 – 2013-01-15 23:00:00   
